...
export class PlanesService {
    ...
    constructor() {
      this.planesSuscripcion.push(new PlanSuscripcion(1, 'Plan básico', 3000, '720p', true));
      this.planesSuscripcion.push(new PlanSuscripcion(2, 'Plan estándar', 5000, '1024p', true));
      this.planesSuscripcion.push(new PlanSuscripcion(3, 'Plan premium', 7000, '4k', false));
    }
