...
import { Reproduccion } from 'src/models/reproduccion';
...
export class UsuariosService {
    ...
    constructor(private readonly planesServices: PlanesService) {
        this.usuarios.push(new Usuario(1, 'usuario1', 'usuario1@mail.cl', 7, 'asds',this.planesServices.obtenerPlan(3), [], ['Animación', 'Fantasía']));
        this.usuarios.push(new Usuario(2, 'usuario2', 'usuario2@mail.cl', 15, 'asds',this.planesServices.obtenerPlan(2), [], ['Acción', 'Aventura']));
        this.usuarios.push(new Usuario(3, 'usuario3', 'usuario3@mail.cl', 23, 'asds',this.planesServices.obtenerPlan(1), [], ['Ciencia Ficción']));
    }
