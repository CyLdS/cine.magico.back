...
export class PeliculasService {
    ...
    constructor() {
        this.peliculas.push(new Pelicula(1, 'Toy Story','Animación',2020,'TE',81,'Inglés',['Español', 'Francés', 'Alemán'],false));
        this.peliculas.push(new Pelicula(2,'Harry Potter y la piedra filosofal','Fantasía',152,'TE',100,'Inglés',['Español','Francés','Alemán'],false));
        this.peliculas.push(new Pelicula(3,'El juego del miedo','Terror',2020,'TE',117,'Inglés',['Español', 'Alemán'],false));
